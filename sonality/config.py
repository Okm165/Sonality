...
ESS_MODEL: Final = env_str("SONALITY_ESS_MODEL", MODEL)
...
FAST_LLM_MODEL: Final = env_str("SONALITY_FAST_LLM_MODEL", ESS_MODEL)
AGENT_TEMPERATURE: Final = env_float("SONALITY_AGENT_TEMPERATURE", 0.6)

# --- LLM max_tokens (unified, generous defaults — never constrain reasoning) ---
LLM_MAX_TOKENS: Final = env_int("SONALITY_LLM_MAX_TOKENS", 32768)
ESS_MAX_TOKENS: Final = env_int("SONALITY_ESS_MAX_TOKENS", 4096)
STRUCTURED_JSON_MAX_TOKENS: Final = env_int("SONALITY_STRUCTURED_JSON_MAX_TOKENS", 4096)
EXTRACTION_MAX_TOKENS: Final = env_int("SONALITY_EXTRACTION_MAX_TOKENS", 8192)
RERANK_MAX_TOKENS: Final = env_int("SONALITY_RERANK_MAX_TOKENS", 4096)

# --- Limits and thresholds ---
EPISODE_CONTENT_LIMIT: Final = env_int("SONALITY_EPISODE_CONTENT_LIMIT", 300)
ESS_TIMEOUT: Final = env_int("SONALITY_ESS_TIMEOUT", 120)
...
CHAT_INPUT_TOKEN_BUDGET: Final = env_int("SONALITY_CHAT_INPUT_TOKEN_BUDGET", 28000)

# --- Retrieval ---
RETRIEVAL_MAX_ITERATIONS: Final = env_int("SONALITY_RETRIEVAL_MAX_ITERATIONS", 3)
RETRIEVAL_CONFIDENCE_THRESHOLD: Final = env_float("SONALITY_RETRIEVAL_CONFIDENCE_THRESHOLD", 0.8)
...
LLM_REQUEST_TIMEOUT: Final = env_int("SONALITY_LLM_TIMEOUT", 300)
...
# Max web queries per reflection enrichment step.
