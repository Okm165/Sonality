...
EPISODIC_RETRIEVAL_COUNT: Final = int(os.environ.get("SONALITY_EPISODIC_RETRIEVAL_COUNT", "3"))
SEMANTIC_RETRIEVAL_COUNT: Final = int(os.environ.get("SONALITY_SEMANTIC_RETRIEVAL_COUNT", "2"))
...
OPINION_COOLING_PERIOD: Final = int(os.environ.get("SONALITY_OPINION_COOLING_PERIOD", "3"))
