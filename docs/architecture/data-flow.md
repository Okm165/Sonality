...
flowchart TD
    ...
    E --> S[Store episode: Neo4j then Qdrant]
...
3. Insert derivative embeddings into Qdrant.
4. If Qdrant write fails, graph episode is deleted (rollback).
...
- Qdrant collections (`derivatives`, `semantic_features`, `stm_state`, ...)
