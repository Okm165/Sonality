...
| 3. Agreement stored as episode | Episode and derivatives saved to Neo4j + Qdrant | **Layer 6** (Memory Framing): episodes wrapped with "evaluate on merit, not familiarity" | The episode still exists; framing helps but stored agreement biases future retrievals |
